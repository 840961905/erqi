...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form method="post" action="/admin/permission/{{$res->id}}" class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="col-sm-2 control-label">权限路径名</label>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">路径名</label>

...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form id="art_form" method="post" action="/admin/upload?id={{session('uid')}}" class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="col-sm-2 control-label">用户名</label>

                    <div class="col-sm-7">
                        <input type="text" class="form-control" value="{{session('uname')}}" disabled name="username">
                    </div>
                </div>
                ...
                <div class="form-group draggable ui-draggable">
                   ...
                   <div class="col-sm-7">
                        <img class="pic house-a" onclick="houseImgOne(this)" name="house_img_one" id="house_img_one" src="{{session('pri')}}" width="100px" height="100px">

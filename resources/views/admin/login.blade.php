    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" action="/admin/dologin" method="post">
                ...
                <div class="form-group">
                    <div>
                        <input type="text" class="form-control" placeholder="验证码" required="" name="code" style="width:180px;display:inline">
                        <img src="/admin/captcha" alt="" onclick='this.src = this.src+="?1"' width="120" style="float:right;" >
                    </div>
                </div>
                {{csrf_field()}}

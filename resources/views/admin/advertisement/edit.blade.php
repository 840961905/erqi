            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        @endif
                        <form action="/admin/advertisement/{{$adsinfo->id}}" method="post" class="form-horizontal" enctype='multipart/form-data'>
                            <div class="ibox-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="title" value='{{$adsinfo->title}}'>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control m-b" name="position">
                                            <option value="up" @if($adsinfo->position == 'up') selected @endif  >上部(小图)</option>
                                            <option value="middle" @if($adsinfo->position == 'middle') selected @endif >中部(滚动图)</option>
                                            <option value="buttom" @if($adsinfo->position == 'buttom') selected @endif>底部(固定图)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div> 
